<header id="header" class="navbar navbar-fixed-top bg-info padder-v "  data-spy="affix" data-offset-top="1">
    <div class="container">
      <div class="navbar-header">
        ...
        <a href="{{URL::to('/')}}" class="navbar-brand m-r-lg"><img src="img/logo.png" class="m-r-sm hide"><span class="h3 font-bold">Spaza</span></a>
      </div>
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li style="margin-left: 10px">
            <div class="m-t-sm">
              ...
              <a href="{{URL::to('campaigns/create')}}" class="btn  btn-success btn-addon  "><i class="fa fa-fw fa-twitter"></i>Influencer Portal</a>
            </div>
          </li>
        </ul> 
